...
export interface Attendance {
    ...
    // Timestamps (in milliseconds) and Dates
...
export interface SchoolLocation {
    ...
    longitude?: number;
    latitude?: number;
    allowableDistance?: number; // meter radius from long and lat
}
...
export enum STUDENT_TRIP_STATUS {
    ONBOARD = 'onboard',
    ALIGHTED = 'alighted',
    RETURNED = 'returned',
    EMERGENCY = 'emergency'
...
export enum VEHICLE_TRIP_STATUS {
    ACTIVE = 'active',
    ENDED = 'ended',
...
export interface BulkSMSPayload {
    username: string; // exampaqs username - Exampaqs
    phoneNumbers: string[];
    message: string;
    senderId: string;
}
